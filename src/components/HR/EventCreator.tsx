...
const EventCreator: React.FC = () => {
  ...
  const handleCreateEvent = async () => {
    if (!title || !startDate || !endDate || (eventType === 'position' && !position) || (eventType === 'type' && !type)) {
    ...
    try {
      ...
      let endpoint = '';
      let params: any = { ownerId, title, startDate: formattedStartDate, endDate: formattedEndDate };
