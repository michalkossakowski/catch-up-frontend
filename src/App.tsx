                                ...
                                <Nav className="ms-auto d-flex align-items-center flex-row flex-wrap">
                                    ...
                                    >
                                        <div   className="notifications-dropdown"
                                            ...
                                            style={{
                                                maxHeight: '250px', // Zmniejszona wysokość
                                                maxWidth: '450px',  // Zwiększona szerokość
                                                overflowY: 'auto',  // Włącz przewijanie pionowe
                                                padding: '5px',     // Dodaj padding dla lepszej estetyki
                                            }}
                                        >
                                            {latestNotifications.length === 0 ? (
                                                <NavDropdown.ItemText style={{ padding: '10px', width: '260px' }}>
                                                    You don't have any nootifications
                                                ...
                                                {latestNotifications.map((notification, index) => (
                                                    ...
                                                    >
                                                        {!notification.isRead && (
                                                            <small className="text-primary notification-new" style={{ position: 'absolute', top: '5px', right: '5px' }}>
                                                                New
                                                            </small>
                                                        )}
                                                        <div
                                                            style={{ cursor: 'pointer' }}
                                                            onClick={() => navigate(notification.source)}
                                                ...
                                                <NavDropdown.Item className='more-notifications' onClick={() => navigate('/notifications')}>
